...
-(id)registerClient:(MfsCard*)card token:(NSString*)token textField:(MfsTextField*)textField cvv:(MfsTextField*)cvv checkbox:(MfsCheckbox*)checkbox registerCallback:(SEL)callback registerTarget:(id)target;
...
-(id)getDigitalLoanUrl:(NSString*)token bankIca:(NSString *)bankIca loanBankIca:(NSString *)loanBankIca amount:(NSString*)amount orderNo:(NSString*)orderNo campaignCode:(NSString*)campaignCode basketInfo:(NSString *)basketInfo getDigitalLoanUrlCallback:(SEL)callback getDigitalLoanUrlTarget:(id)target;

-(id)openDigitalLoanUrl:(MfsWebView*)webView iFrameSignature:(NSString *)iFrameSignature returnUrl:(NSString *)returnUrl response:(MfsResponse *)response digitalLoanWebViewCallback:(SEL)digitalLoanWebViewCallback digitalLoanWebViewTarget:(id)digitalLoanWebViewTarget;

-(id)recipientCardRegistration:(NSString*)token cardNumber:(NSString *)cardNumber recipientCardAliasName:(NSString *)recipientCardAliasName recipientCardRegistrationCallback:(SEL)callback recipientCardRegistrationTarget:(id)target;
...
@property (readwrite, nonatomic) SEL getDigitalLoanUrlCallback;
@property (readwrite, nonatomic, strong) id getDigitalLoanUrlHandler;

@property (readwrite, nonatomic) SEL recipientCardRegisterCallback;
@property (readwrite, nonatomic, strong) id recipientCardRegisterHandler;
...
@property (readwrite, nonatomic) BOOL verbose;

@property void (^logBlock)(NSString*);
